...
VALUES ('fea3ba35-4489-4fc3-9037-504ea5afa841'::uuid, 'user:read'),
	...
	('e8dc8d5d-c57c-44a7-b34e-f25b3b708924'::uuid, 'client:read'),
	('a1068f79-a1fc-4677-83b8-8fe96ef63be8'::uuid, 'client:create'),
	('ccaa5ea7-c4c4-408c-8234-64da7676a5c0'::uuid, 'client:update'),
	('dc959ecd-da5a-4ec3-a301-24c50b150c96'::uuid, 'client:delete'),
	('2066f626-496e-460c-b959-1d9b800645e7'::uuid, 'client:view'),
	('8b818c4a-b3b3-4891-8295-b58e95182267'::uuid, 'category:view'),
	('598c6861-9a2b-4dd3-9963-f22d1155e0f0'::uuid, 'category:update'),
	('6be7d629-6c16-4bfd-9d27-ff5041b4300b'::uuid, 'category:delete'),
	('d340cb2e-0f9c-437d-96b5-366dbedd1e78'::uuid, 'category:read'),
	('db170eef-eebe-4634-8fe8-c2e16e65ee13'::uuid, 'category:create'),
	('ca21f67d-3286-468b-ab63-f379bdee95a1'::uuid, 'product:view'),
	('760e0b57-a037-4698-882f-49c2925e5e04'::uuid, 'product:update'),
	('d29120af-2471-45d7-8a78-b9f2b53a5347'::uuid, 'product:delete'),
	('fd0f27e4-c78c-4d0f-9781-e75e902e4bb8'::uuid, 'product:read'),
	('02d3a5db-400d-4d14-ad8a-50b7ca6fd42e'::uuid, 'product:create'),
	('350321de-7df3-4936-8488-90a1000d5b61'::uuid, 'provider:view'),
	('3de24380-5e2a-4950-a63f-377bb985a662'::uuid, 'provider:update'),
	('4d1f42e8-1779-4b3c-ab46-7be58007dfc5'::uuid, 'provider:delete'),
	('4853cb05-8f26-4e93-ba17-b33a6558613f'::uuid, 'provider:read'),
	('e1921ab0-e023-40b8-80b2-a66b4011849c'::uuid, 'provider:create'),
	('c0f664f0-e91e-4c6f-917f-311a8c24e8f7'::uuid, 'sale:view'),
	('d6aeb017-142c-4d48-ba38-fb1b0c66fcf2'::uuid, 'sale:update'),
	('dccb6571-3c3e-41bc-a156-4588b3d51acd'::uuid, 'sale:delete'),
	('54749112-b11d-4490-ac74-7901912f4cc0'::uuid, 'sale:read'),
	('8d5bddf0-fdeb-495a-87d1-c9ed83859cb4'::uuid, 'sale:create'),
	('db551fff-8ae1-4519-9d65-50aba907de85'::uuid, 'sale:detail');
